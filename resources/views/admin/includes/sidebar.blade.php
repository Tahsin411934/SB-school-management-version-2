...
<ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #212529;">
    ...
    @endif
    @if ($user->can('monthlyFee.create') || $user->can('monthlyFee.view') || $user->can('monthlyFee.edit') ||
    $user->can('monthlyFee.delete'))
    <!-- Nav Item - Category -->
    <li class="nav-item">
    ...
    <!-- Nav Item - Category -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseStationaryFeeBuy"
            aria-expanded="true" aria-controls="collapseStationaryFeeBuy">
            <i class="fas fa-fw fa-th"></i>
