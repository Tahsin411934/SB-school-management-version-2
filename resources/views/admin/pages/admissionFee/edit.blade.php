                ...
                <div class="p-5">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Admission Fee</h6>
                            @if (Session::has('msg'))
                        ...
                        <div class="card-body">
                            <form class="user" action="{{ URL::to('admin/update-admissionFee/' . $data->id) }}"
                                method="POST">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                ...
                                <div id="dynamic-field-container">
                                    @forelse ($data->studentClass->admissionFees as $index => $fee)
