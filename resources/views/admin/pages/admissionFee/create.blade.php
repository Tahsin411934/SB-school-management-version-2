                ...
                <div class="p-5">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Create Admission Fee</h6>
                            @if (Session::has('msg'))
                        ...
                        <div class="card-body">
                            <form class="user" action="{{ URL::to('admin/store-admissionFee') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="class_id" name="class_id">
                                                ...
                                                @foreach ($studentClasses as $class)
                                                    <option value="{{ $class->id }}"
                                                        ...
                                                        {{ in_array($class->id, $classesWithAdmissionFees) ? 'disabled class=disabled-option' : '' }}>
                                                        {{ $class->name }}
                                                    </option>
                                                @endforeach
                                            </select>
